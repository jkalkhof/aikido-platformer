game.GameOverScreen = me.ScreenObject.extend({
    ...
    addTextArea : function() {
      ...
      var textArea = new (me.Renderable.extend ({
          // constructor
          init : function() {
              console.log("GameOverScreen: onResetEvent: Renderable: init");
              ...
              this.synopsisText = 'Congratulations!  You beat the first level. \
Please comment on the developer forum page if you would like to see more.\
';
          ...
          onDestroyEvent : function() {
              console.log("GameOverScreen: onResetEvent: Renderable: onDestroyEvent");
          }
      }));
    ...
    onResetEvent : function() {
        ...
        this.handler = me.event.subscribe(me.event.KEYDOWN, function (action, keyCode, edge) {
            if (action === "enter") {
                ...
                console.log("GameOverScreen: enter action");
            }
        });
    },
